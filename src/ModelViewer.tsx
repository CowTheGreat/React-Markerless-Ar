...
// function AnimatedModel({ modelPath }: AnimatedModelProps) {
...
//   return (
//     <primitive ref={group} object={scene} scale={1.5} position={[0, -1, 1]} />
//   );
// }
...
//         </Suspense>
//         <OrbitControls enableZoom={true} zoomSpeed={0.8} enablePan={false} />
//       </Canvas>
//     </div>
//   );
// }
